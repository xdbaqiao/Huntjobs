...
public class NwpuActivity extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        NetworkHtml.HttpTest(NwpuActivity.this);
        ...
        liststr = HuntjobsActivity.htmlnwpu;
        if(liststr != null)
            updateListView();
        else
        ...
        listViewDetail.setOnItemClickListener(new OnItemClickListener()
        {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) 
     		{
                ...
                progressDialog = ProgressDialog.show(NwpuActivity.this, "请稍等...", "获取数据中...", true);
                url = "http://job.nwpu.edu.cn/nwpujy/List/" + listnews.get(arg2).getCompanyurl();
                ...
                {  
                    ...
                    {  
                        ...
                        if(html3 != null) 
                        {
                        	    SouthActivity.html7 = NetworkHtml.getNwpuDetail(html3);
                                Message m = new Message();   
                                m.what = NwpuActivity.GUI_STOP_NOTIFIER;  
                                NwpuActivity.this.myMessageHandler.sendMessage(m);  
                        }  
                     }  
                }).start();  
			}	
    ...
    Handler myMessageHandler = new Handler() {  
        ...
        public void handleMessage(Message msg) {  
            ...
            case XJActivity.GUI_STOP_NOTIFIER:  
                ...
                Intent intent = new Intent(NwpuActivity.this, DetailActivity.class);
                NwpuActivity.this.startActivity(intent);
