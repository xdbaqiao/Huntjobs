...
public class SouthActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        NetworkHtml.HttpTest(SouthActivity.this);
        ...
        liststr = HuntjobsActivity.html22;
        if(liststr != null)
            updateListView();
        ...
        listViewDetail.setOnItemClickListener(new OnItemClickListener()
        {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) 
     		{
                ...
                progressDialog = ProgressDialog.show(SouthActivity.this, "请稍等...", "获取数据中...", true);
                ...
                {  
                    ...
                    {  
                        ...
                        if(html3 != null) 
                        {
                        	    html7 = NetworkHtml.getDetail(html3);
                                Message m = new Message();   
                                m.what = SouthActivity.GUI_STOP_NOTIFIER;  
                                SouthActivity.this.myMessageHandler.sendMessage(m);  
                        }  
                     }  
                }).start();  
			}	
    ...
    Handler myMessageHandler = new Handler() {  
        ...
        public void handleMessage(Message msg) {  
            switch (msg.what) {  
            case SouthActivity.GUI_STOP_NOTIFIER:  
            	progressDialog.dismiss();
                Intent intent = new Intent(SouthActivity.this, DetailActivity.class);
                SouthActivity.this.startActivity(intent);
